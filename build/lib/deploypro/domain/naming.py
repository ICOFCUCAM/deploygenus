...
def image_tag(project_slug: str, git_sha: str) -> str:
    ...
    """
    return f"deploypro/{project_slug}:{git_sha[:12]}"
...
def worker_container_name(project_slug: str, process: str, replica: int) -> str:
    ...
    """
    return f"deploypro-{project_slug}-{process}-{replica}"
...
def job_container_name(project_slug: str, process: str, slot: str) -> str:
    ...
    """
    return f"deploypro-job-{project_slug}-{process}-{slot}"
